...
#collate all WQG####
usepa_opp <- read_excel("C:\\Users\\erinm\\OneDrive\\Desktop\\GLRI Project\\GLRI Chemical Prioritization\\Water Quality Guidelines\\WQG_repository.xlsx", "USEPA_OPP")
ccme <- read_excel("C:\\Users\\erinm\\OneDrive\\Desktop\\GLRI Project\\GLRI Chemical Prioritization\\Water Quality Guidelines\\WQG_repository.xlsx", "CCME")
cad_data <- read_excel("C:\\Users\\erinm\\OneDrive\\Desktop\\GLRI Project\\GLRI Chemical Prioritization\\Water Quality Guidelines\\WQG_repository.xlsx", "CAD_data")
feqgcs <- read_excel("C:\\Users\\erinm\\OneDrive\\Desktop\\GLRI Project\\GLRI Chemical Prioritization\\Water Quality Guidelines\\WQG_repository.xlsx", "FEQGCs")
EU_EQS <- read_excel("C:\\Users\\erinm\\OneDrive\\Desktop\\GLRI Project\\GLRI Chemical Prioritization\\Water Quality Guidelines\\WQG_repository.xlsx", "EU_EQS")
usepa_reg4 <- read_excel("C:\\Users\\erinm\\OneDrive\\Desktop\\GLRI Project\\GLRI Chemical Prioritization\\Water Quality Guidelines\\WQG_repository.xlsx", "USEPA_Reg4")
noaa_sqrt <- read_excel("C:\\Users\\erinm\\OneDrive\\Desktop\\GLRI Project\\GLRI Chemical Prioritization\\Water Quality Guidelines\\WQG_repository.xlsx", "NOAA_SQRT")
usepa_ecotox <- read_excel("C:\\Users\\erinm\\OneDrive\\Desktop\\GLRI Project\\GLRI Chemical Prioritization\\Water Quality Guidelines\\WQG_repository.xlsx", "USEPA_ECOTOX")
usepa_esb <- read_excel("C:\\Users\\erinm\\OneDrive\\Desktop\\GLRI Project\\GLRI Chemical Prioritization\\Water Quality Guidelines\\WQG_repository.xlsx", "USEPA_ESB")
usepa_nrwqc <- read_excel("C:\\Users\\erinm\\OneDrive\\Desktop\\GLRI Project\\GLRI Chemical Prioritization\\Water Quality Guidelines\\WQG_repository.xlsx", "USEPA_NRWQC")
cad_prov <- read_excel("C:\\Users\\erinm\\OneDrive\\Desktop\\GLRI Project\\GLRI Chemical Prioritization\\Water Quality Guidelines\\WQG_repository.xlsx", "CAD_Prov")
usepa_cwa <- read_excel("C:\\Users\\erinm\\OneDrive\\Desktop\\GLRI Project\\GLRI Chemical Prioritization\\Water Quality Guidelines\\WQG_repository.xlsx", "USEPA_CWA2")
norman <- read_excel("C:\\Users\\erinm\\OneDrive\\Desktop\\GLRI Project\\GLRI Chemical Prioritization\\Water Quality Guidelines\\WQG_repository.xlsx", "NORMAN")
echa <- read_excel("C:\\Users\\erinm\\OneDrive\\Desktop\\GLRI Project\\GLRI Chemical Prioritization\\Water Quality Guidelines\\WQG_repository.xlsx", "ECHA")
